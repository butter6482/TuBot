...
export const BotCreationModal = ({ onClose, onSave }: BotCreationModalProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (name.trim()) {
      onSave({ name, personality, documents });
    }
  };
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 backdrop-blur-sm">
      <div
        className="bg-gray-900 border border-cyan-500 rounded-lg w-full max-w-md p-6 relative"
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-gray-800 border border-gray-700 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500 min-h-[100px]"
                placeholder="Describe how you want your bot to behave..."
              />
            </div>
            <div>
              ...
              <div className="flex space-x-2">
                <input
                  ...
                  className="flex-1 bg-gray-800 border border-gray-700 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500"
              ...
              {documents.length > 0 && (
                <div className="mt-2 space-y-1">
                  {documents.map((doc, index) => (
                    <div key={index} className="flex items-center justify-between bg-gray-800 px-3 py-1 rounded">
          ...
          <div className="mt-6 flex justify-end">
            ...
            <button
              type="submit"
              className="ml-3 px-4 py-2 bg-gradient-to-r from-cyan-500 to-purple-600 text-white rounded-md hover:shadow-lg hover:shadow-cyan-500/25"
            >
              Create Bot
            </button>
          </div>
